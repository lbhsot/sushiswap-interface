...
import { useV2PairWithPairMap } from 'app/hooks/useV2Pairs'
...
export function useDerivedBurnInfoWithPairMap(
  currencyA: Currency | undefined,
  currencyB: Currency | undefined,
  ...
  // pair + totalsupply
  const [, pair] = useV2PairWithPairMap(pairMap, currencyA, currencyB)
